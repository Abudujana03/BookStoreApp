      ...
      <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
        <div className="order-2 w-full md:order-1 md:w-1/2  mt-12 md:mt-32">
          <div className='space-y-8'>
            ...
            <p className='text-xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Explicabo architecto ad quo voluptates debitis quia
              eaque nemo perferendis molestiae harum .</p>
        ...
        <div className="order-1 w-full md:w-1/2 mt-20">
          <img src={Banner2} className='md:w-[550px] md:h-[460px] md:ml-12'/>
        </div>
      </div>
    </>
  )
